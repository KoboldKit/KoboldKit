...
typedef enum : unsigned char
{
	...
	KTTilemapOrientationStaggeredIsometric, /**< A "staggered" isometric tilemap (new in Tiled v0.9) */
	KTTilemapOrientationHexagonal,          /**< A hexagonal tilemap - removed from Tiled v0.9 :( */
